<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="手机号" prop="bookPhone">
        <el-input
      ...
      <el-form-item label="生日" prop="bookBirthday">
        <el-date-picker clearable
          v-model="queryParams.bookBirthday"
          type="date"
    ...
    <el-table v-loading="loading" :data="bookList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="电话本ID" align="center" prop="bookId" />
      <el-table-column label="姓名" align="center" prop="bookName" />
      <el-table-column label="手机号" align="center" prop="bookPhone" />
      <el-table-column label="生日" align="center" prop="bookBirthday" width="180">
        <template slot-scope="scope">
          <span>{{ parseTime(scope.row.bookBirthday, '{y}-{m}-{d}') }}</span>
        </template>
      </el-table-column>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="手机号" prop="bookPhone">
          <el-input v-model="form.bookPhone" placeholder="请输入手机号" />
        </el-form-item>
        <el-form-item label="生日" prop="bookBirthday">
          <el-date-picker clearable
            v-model="form.bookBirthday"
            type="date"
            value-format="yyyy-MM-dd"
            placeholder="请选择生日">
          </el-date-picker>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除电话本编号为"' + bookIds + '"的数据项？').then(function() {
